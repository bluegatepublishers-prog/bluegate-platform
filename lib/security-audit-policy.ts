export const SECURITY_AUDIT_ACTIONS = [
  ...
  "school.student.password_reset",
  "school.student.account_activation.bulk",
  "school.teacher.bulk_import",
  "school.teacher.membership.close",
  "school.report_card.issue",
  "school.portal_permissions.update",
  "school.parent_portal.enable",
  "school.parent_portal.disable",
  "school.mentor_portal.enable",
  "school.mentor_portal.disable",
  "publisher.school_feature.enable",
  "publisher.school_feature.disable",
  "school.parent.activate",
  "school.parent.deactivate",
  "school.mentor.activate",
  "school.mentor.deactivate",
  ...
  "publisher.curriculum.unit.delete",
  "publisher.curriculum.chapter.delete",
  "publisher.curriculum.module.delete",
  "publisher.curriculum.topic.delete",
