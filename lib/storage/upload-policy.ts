...
export const uploadRules: Record<UploadScope, { extensions: string[]; contentTypes: string[]; maxSize: number; prefix: string }> = {
  ...
  "resource-file": { extensions: [".pdf", ".ppt", ".pptx", ".doc", ".docx", ".zip", ".mp4", ".webm", ".mov", ".mp3", ".wav", ".m4a", ".ogg"], contentTypes: ["application/pdf", "application/vnd.ms-powerpoint", "application/vnd.openxmlformats-officedocument.presentationml.presentation", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/zip", "application/x-zip-compressed", "video/mp4", "video/webm", "video/quicktime", "audio/mpeg", "audio/wav", "audio/x-wav", "audio/mp4", "audio/ogg"], maxSize: 100 * MB, prefix: "resources/files" },
