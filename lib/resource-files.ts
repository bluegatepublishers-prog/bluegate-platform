...
function isResourceUrl(url:string){if(url.startsWith("/uploads/resources/"))return true;try{return /^\/(?:publishers\/[^/]+\/)?resources\//.test(new URL(url).pathname)}catch{return false}}
