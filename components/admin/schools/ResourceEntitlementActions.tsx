...
import { changeSchoolResourceEntitlementAction } from "@/app/admin/schools/[id]/content-actions";

export default function ResourceEntitlementActions({
  schoolId,
  entitlementId,
  status,
}: {
  ...
  const action =
    changeSchoolResourceEntitlementAction.bind(
      null,
      schoolId,
      entitlementId,
    );
    ...
    <>
      ...
      >
        <button
          ...
          aria-label="Resource entitlement actions"
