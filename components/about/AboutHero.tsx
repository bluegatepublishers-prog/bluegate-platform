...
export default function AboutHero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#083A75] via-[#0B5ED7] to-[#4F8EF7] py-28 text-white">
      ...
      <div className="absolute bottom-0 left-0 h-56 w-56 rounded-full bg-yellow-400/20 blur-3xl"></div>
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <span className="rounded-full bg-white/20 px-5 py-2 text-sm tracking-wider">
            ...
            <div className="mt-10 flex flex-wrap gap-5">
              ...
              <Link
                href="/books"
                className="rounded-xl bg-white px-8 py-4 font-semibold text-[#083A75] transition hover:scale-105"
              >
                Explore Books
              </Link>
              ...
              <Link
                href="/contact"
                className="rounded-xl border border-white px-8 py-4 font-semibold transition hover:bg-white hover:text-[#083A75]"
              >
                Contact Us
              </Link>
