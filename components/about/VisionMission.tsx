        ...
        <div className="mt-16 grid gap-10 lg:grid-cols-2">
          ...
          <div className="rounded-[32px] bg-white p-10 shadow-lg transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
            ...
            <div className="flex h-20 w-20 items-center justify-center rounded-full bg-blue-100">
              ...
              <Eye size={38} className="text-[#0B5ED7]" />
          ...
          <div className="rounded-[32px] bg-gradient-to-br from-[#0B5ED7] to-[#083A75] p-10 text-white shadow-lg transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
