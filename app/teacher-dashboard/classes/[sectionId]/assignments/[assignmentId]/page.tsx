...
export default async function Page({ params }: { params: Promise<{ sectionId: string; assignmentId: string }> }) {
  ...
  return <div className="space-y-5">
    ...
    <SubmissionReviewList sectionId={sectionId} assignmentId={assignment.id} students={students} totalMarks={assignment.totalMarks} allowResubmission={assignment.allowResubmission} maximumAttempts={assignment.maximumAttempts} />
  </div>;
}
