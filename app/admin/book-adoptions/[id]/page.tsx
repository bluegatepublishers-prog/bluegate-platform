...
export default async function BookAdoptionPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const cover = bookCoverPath(item.book.id, item.book.coverImage);
